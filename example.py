...
print("Submodel generated by (M3, 50):")
print(structure.generate_submodel(M3, 50), '\n')
...
print("Largest filtration of M2 through {phi, psi}:")
print(structure.generate_largest_filtration(M2, syntax.subformula_close({phi, psi})))
